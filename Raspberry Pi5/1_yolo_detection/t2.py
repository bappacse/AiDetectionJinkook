...
while True:
    ...
    # 调整图像大小
    resized_image = cv2.resize(target_image1, (320, 224))
    count += 1
    ...
    for index,row in px.iterrows():
        ...
        cv2.rectangle(target_image1,(x1*2,y1*2),(x2*2,y2*2),(0,0,255),2)
        if d == 0:
            cvzone.putTextRect(target_image1,f'{c}, {conf_score:.2f}',(x1*2,y1*2-20),1,1)
        elif d == 1:
            cvzone.putTextRect(target_image1,f'{c}, {conf_score:.2f}',(x1*2,y1*2-40),1,1)
